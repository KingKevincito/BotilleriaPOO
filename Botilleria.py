class Drinkable
{
    ...
    code=""               #codigo de barra del bebestible
    sale_price=""         #valor del bebestible
    expiration_date=""    #fecha de expiracion del bebestible
    ML=""                 #la cantidad de Mililitros que contiene el embase
    stock=""              #cantidad del bebestible elegido en la tienda 
    sale_restriction=""   #la edad necesaria para la compra del bebestible
